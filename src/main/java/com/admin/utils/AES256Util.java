...
public class AES256Util {
     ...
     * 密钥, 256位32个字节
     */
    public static final String DEFAULT_SECRET_KEY = "Guz(%&hj7x89H$yuBI04A256FtmaT5&f";
     ...
     */
    private static final byte[] KEY_VI = "E4ghj*Ghg7!rNIfb".getBytes();
